...
const SellerRegistrationSection: React.FC = () => {
  return (
    <div className="w-full lg:w-1/2 p-8 bg-white rounded-lg shadow-lg m-10">
      <h2 className="text-3xl font-bold mb-6 text-sky-900">Seller Registration</h2>
      <form className="space-y-6">
        ...
        <button type="submit" className="bg-slate-800 text-white py-2 px-4 rounded-md hover:bg-slate-700 focus:outline-none focus:shadow-outline-blue">
          Register as Seller
        </button>
      </form>
    </div>
...
export default SellerRegistrationSection;
